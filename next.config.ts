...
const nextConfig: NextConfig = {
        ...
        headers: [
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; font-src 'self' data:; connect-src 'self' https://*.supabase.co https://*.vimeo.com; frame-src 'self' https://player.vimeo.com;"
          }
        ]
      },
      {
  ...
  // Lisätään myös muut tietoturva-asetukset
  poweredByHeader: false,
  compress: true,
  generateEtags: false,
  // Estetään tiedostojen paljastus
  onDemandEntries: {
